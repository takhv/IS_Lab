...
const HumanBeingTable: React.FC<HumanBeingTableProps> = ({ onEdit }) => {
  const [heroes, setHeroes] = useState<HumanBeing[]>([]); // Убедитесь, что это массив
  const [loading, setLoading] = useState(true);
  const [error, setError] = useState<string | null>(null); // Добавим состояние ошибки
  ...
  // Проверить, что heroes — массив перед использованием map
